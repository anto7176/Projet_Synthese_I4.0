...
# ---- AFFICHAGE ----
# PDP des variables de la chambre 3
print("Génération PDP chambre 3...")
...
# PDP de toutes les variables
print("Génération PDP toutes variables...")
...
# PDP 2D — interaction T_data_3_1 x H_data
print("Génération PDP 2D (interaction)...")
fig, ax = plt.subplots(figsize=(8, 6))
PartialDependenceDisplay.from_estimator(
    rf, X_train, [('T_data_3_1', 'H_data')],
    ax=ax, kind='average'
)
ax.set_title("PDP 2D — Interaction T_data_3_1 x H_data", fontsize=12)
plt.tight_layout()
