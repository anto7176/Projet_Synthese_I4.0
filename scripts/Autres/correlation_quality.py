...
# ── Autocorrélation de quality ─────────────────────────────────────────────
fig, axes = plt.subplots(2, 1, figsize=(12, 8))

# Plot 1 : ACF sur 48 lags (48h)
plot_acf(data_Y_formatee, lags=24, ax=axes[0], color='#4C72B0')
axes[0].set_title("Autocorrélation de quality (24 heures = 24h)")
axes[0].set_xlabel("heures")
axes[0].set_ylabel("Corrélation")

# Plot 2 : quality brute dans le temps
