...
# ── Option 1 : join exact (ce qu'on faisait avant) ────────────────
df_exact = df_x_final.join(df_y_final, how='inner')
...
# Tronquer l'index de X à l'heure
...
# Tronquer l'index de Y à l'heure aussi
df_y_tronque = df_y_final.copy()
