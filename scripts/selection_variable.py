...
# ── Étape 1 : entraîner un RF complet pour obtenir l'ordre d'importance ──
...
# ── Étape 2 : entraîner un RF pour chaque sous-ensemble cumulatif ──
resultats = []
...
# Annotations sur le graphique R²
for ax in axes:
...
# Ligne verticale au point de saturation (où R² n'augmente plus beaucoup)
seuil_r2 = res_df['R2'].max() * 0.99  # 99% du R² max
